...
const translations = {
    ...
    rangeDate: { en: 'Date', ja: '日時' },
    rangeMessageId: { en: 'Message ID', ja: 'Message ID' },
    startDate: { en: 'Start Date', ja: '開始日' },
    endDate: { en: 'End Date', ja: '終了日' },
    minMessageId: { en: 'Min Message ID', ja: '最小 Message ID' },
    maxMessageId: { en: 'Max Message ID', ja: '最大 Message ID' },
